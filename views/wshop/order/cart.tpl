...
<html>
    <head>
        ...
        <script type="text/javascript" src="http://cdns.ycchen.cn/scripts/crypto-md5.js"></script>
    ...
    <section class="orderopt" id="exptime-selector">
        ...
        <!-- 微信支付按钮 -->
        <div class="button green" style='display: none' id="wechat-payment-btn">微信安全支付</div>
        <!-- 微信JSSDK -->
