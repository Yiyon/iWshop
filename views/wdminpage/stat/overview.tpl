...
<div style="padding: 15px;">
    ...
    <div class="panel panel-default">
        ...
        <ul class="nav nav-tabs" role="tablist" style="margin-top: -1px;margin-left: -1px;">
            <li role="presentation" class="active"><a href="#new_user" aria-controls="new_user" role="tab" data-toggle="tab">新增粉丝({$newFans.new_user})</a></li>
            <li role="presentation"><a href="#cancel_user" aria-controls="cancel_user" role="tab" data-toggle="tab">取消关注({$newFans.cancel_user})</a></li>
            <li role="presentation"><a href="#pure_user" aria-controls="pure_user" role="tab" data-toggle="tab">净增粉丝({$newFans.new_user - $newFans.cancel_user})</a></li>
            <li role="presentation"><a href="#cumulate_user" aria-controls="cumulate_user" role="tab" data-toggle="tab">粉丝总数({$totalFans.cumulate_user})</a></li>
        </ul>
