...
if (scriptTag) {
    ...
    require.config({
        paths: {
            jquery: 'http://cdns.ycchen.cn/scripts/jquery-1.7.2.ext.min',
            bootstrap: 'http://cdns.ycchen.cn/scripts/bootstrap.min',
            util: 'Wdmin/util',
            Spinner: 'http://cdns.ycchen.cn/scripts/spin.min',
            highcharts: 'http://cdns.ycchen.cn/scripts/highcharts',
            fancyBox: 'lib/fancyBox/source/jquery.fancybox.pack',
            datatables: 'lib/DataTables/media/js/jquery.dataTables.min',
            jqPaginator: 'http://cdns.ycchen.cn/scripts/jqPaginator',
            provinceCity: 'lib/provinceCity',
            jUploader: 'http://cdns.ycchen.cn/scripts/jUploader.min',
            ...
            pagination: 'http://cdns.ycchen.cn/scripts/jquery.pagination.min',
            datetimepicker: 'http://cdns.ycchen.cn/scripts/jquery.datetimepicker.full.min',
            baiduTemplate: 'http://cdns.ycchen.cn/scripts/baiduTemplate',
            'jquery-mousewheel': 'http://cdns.ycchen.cn/scripts/jquery-mousewheel',
