            ...
            {foreach from=$slist item=sl}
                <a class="slist-item" href="{$docroot}?/vProduct/view/id={$sl.product_id}&showwxpaytitle=1">
                    <div class='pd-box-inner'>
                        <img src="{if $config.usecdn}{$config.imagesPrefix}product_hpic/{$sl.catimg}_x120{else}static/Thumbnail/?w=120&h=120&p={$config.productPicLink}{$sl.catimg}{/if}"
                             alt='{$sl.product_name}'/>
...
<script data-main="{$docroot}static/script/Wshop/shop_vproduct.js"
        src="{$docroot}static/script/require.min.js"></script>
</body>
</html>