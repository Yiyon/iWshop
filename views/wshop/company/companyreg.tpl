...
<html>
    <head>
        ...
        <script type="text/javascript" charset="utf-8" src="{$docroot}static/script/lib/validation/dist/jquery.validate.js"></script>
        <script type="text/javascript" charset="utf-8" src="{$docroot}static/script/lib/validation/dist/lang-cn.js"></script>
    </head>
    <body>        
