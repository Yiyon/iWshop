...
<html>
    ...
    <body style='background: #f7f7f7;'>
        ...
        <div id="odcomment">
            <div class="clearfix">
                {foreach from=$order.products item=pd}
                    <img class="pdimg" src="static/Thumbnail/?w=160&h=160&p={$config.productPicLink}{$pd.catimg}" height="80px" width="80px" />
                {/foreach}
            </div>
            ...
            <div id="commentField">
                <textarea id="commentText" placeholder="写下在购物过程中，您的建议和意见"></textarea>
            </div>
        </div>
        ...
        <script data-main="{$docroot}static/script/Wshop/shop_ordercomment.js" src="{$docroot}static/script/require.min.js"></script>
