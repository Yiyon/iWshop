<div class="bottom_nav">
    <a class="nav_index {if $controller eq 'Index'}hover{/if}" href="{$docroot}"><i></i>购物</a>
    <a class="nav_search {if $controller eq 'vProduct'}hover{/if}" href="{$docroot}?/vProduct/view_category/"><i></i>搜索</a>
