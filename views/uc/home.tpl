...
<div class="uc-section" onclick="location.href = '?/Uc/orderlist';"><i
            class='dingdan'></i><b>查看全部已购宝贝</b>我的订单
</div>
...
<div class='uc-order-sec clearfix'>
    ...
    <a class='uc-order-btn tuikuan' href="?/Uc/orderlist/status=canceled"><i></i>退款<b class='prices'>{$count[4]}</b></a>
</div>

<div class="uc-section" onclick="location.href = '{$docroot}?/Uc/uc_likes/'">
    <i></i><b>我喜欢，我收藏</b>我的收藏
</div>

<div class="uc-section" onclick="location.href = '{$docroot}?/Uc/credit_exchange/'">
    <i class='credit'></i><b>您有{$userinfo.client_credit}积分可兑换</b>积分兑换
</div>

{if $companyOn}
    {if $userinfo.is_com eq 1}
        <div class="uc-section" onclick="location.href = '?/Uc/companySpread/'">
            <i class='hezuo'></i><b>总收益：{$income} &yen;</b>我的代理
        </div>
        <div class="uc-section" onclick="location.href = '?/Uc/companyEdit/'">
    ...
    {if $userinfo.is_com eq 0}
        <div class="uc-section" onclick="location.href = '?/Company/companyRequest/'">
...
<script data-main="static/script/Wshop/shop_uchome.js?v={$config.cssversion}"
        src="static/script/require.min.js"></script>
