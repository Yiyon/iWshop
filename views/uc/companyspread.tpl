...
<html>
    ...
    <body>
		...
		<div class="comspreadstat clearfix">
			<span class="spread-item" style="width:50%;">荣誉等级<b>
				{if $comtype eq 1}{$typenum[0]}
					{elseif $comtype eq 2}{$typenum[1]}
					{elseif $comtype eq 3}{$typenum[2]}
					{elseif $comtype eq 4}{$typenum[3]}
					{elseif $comtype eq 5}{$typenum[4]}
					{elseif $comtype eq 6}{$typenum[5]}
					{elseif $comtype eq 7}{$typenum[6]}
					{elseif $comtype eq 8}{$typenum[7]}
					{elseif $comtype eq 9}{$typenum[8]}
				{/if}
			</b></span>
