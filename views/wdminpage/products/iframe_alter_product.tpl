...
<link rel="stylesheet" type="text/css" href="static/less/jquery.datetimepicker.css"/>
        ...
        <div class="clearfix">
            ...
            <div id="alterProductLeft">
                ...
                <div class="fv2Field clearfix">
                    ...
                    <div class="fv2Right">
                        <select id="pd-suppliers" name="product_supplier">
                            <option value="0" {if $pd.suppiler eq 0}selected{/if}>无</option>
                            {foreach from=$suppliers item=supp}
                                <option value="{$supp.id}" {if $pd.product_supplier eq $supp.id}selected{/if}>{$supp.supp_name}</option>
                            {/foreach}
                        </select>
                    </div>
                </div>    
                ...
                <div class="fv2Field clearfix">
                    ...
                    <div class="fv2Right">
                        <input type="text" name="sell_price" class="gs-input" onclick="this.select();" value="{if $ed}{$pd.sale_prices}{else}0.00{/if}" id="pd-form-prices" /> 
                    </div>
                </div>    
                ...
                <div class="fv2Field clearfix">
                    ...
                    <div class="fv2Right">
                        <input type="text" class="gs-input" name="product_origin" value="{if $ed > 0}{$pd.product_origin}{/if}"/>
                ...
                <div class="fv2Field clearfix">
                    ...
                    <div class="fv2Right">
                        <input type="text" class="gs-input" name="product_storage" value="{if $ed > 0}{$pd.product_storage}{/if}"/>
                ...
                <div class="fv2Field clearfix">
                    ...
                    <div class="fv2Right">
                        <input type="text" class="gs-input" name="product_unit" value="{if $ed > 0}{$pd.product_unit}{/if}"/>
                ...
                <div class="fv2Field clearfix">
                    ...
                    <div class="fv2Right">
                        <input type="text" class="gs-input" name="supply_price" value="{if $ed > 0}{$pd.supply_price}{/if}"/>
                ...
                <div class="fv2Field clearfix">
                    ...
                    <div class="fv2Right">
                        <input type="text" class="gs-input" name="product_instocks" value="{if $ed > 0}{$pd.product_instocks}{/if}"/>
                ...
                <div class="fv2Field clearfix">
                    ...
                    <div class="fv2Right">
                        <input type="text" class="gs-input" name="product_expfee" id="pd-expfee" value="{if $ed and $pd.product_expfee > 0}{$pd.product_expfee}{else}0{/if}"/>
        ...
        <div class="fv2Field clearfix" style="max-width:100%;">
            ...
            <div class="fv2Right">
                ...
                <table class="table table-bordered {if $pd.specs|count eq 0}hidden{/if}" id='pd-spec-frame'>
                    <thead>
                        <tr><th style="width: 180px;">规格</th>
                        <th style="width: 180px;" class="hidden">>规格</th>
                        <th>售价</th>
                        <th>市场价</th>
                        <th>库存</th>
                        <th style="width: 40px;">操作</th></tr>
                    </thead>
                    <tbody>
